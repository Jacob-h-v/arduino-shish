// Much of the MPU / DMP code from MPU6050_DMP6.ino library
...
void setup()
{
  ...
  // 115200 baud rate chosen because it is required for Teapot Demo output
  // Baud rate can be changed if not using teapot demo.
  Serial.begin(115200);
